...
There are a good amount of issues like being unable to launch with sound.  In addition, there are many features that could be added like the mute button.  There should be enough work to earn 1000 points, and the expectaions are clear.

###### h) A list of additional issues that you may have added, if any. For each, a link to the issue is good enough.
We have not added any issues. There aren't any real issues we can think of that are not already documented issues. The ones there like converting to JavaFX, increasing test coverage, better main menu, and different study modes are already more than enough to make this a much better product.
